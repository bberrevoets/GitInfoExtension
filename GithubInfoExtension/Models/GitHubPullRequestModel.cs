...
[DataContract]
internal class GitHubPullRequestModel : NotifyPropertyChangedObject
{
    ...
    private string _draftBadge = string.Empty;
    ...
    [DataMember]
    public string DraftBadge
    {
        get => _draftBadge;
        set => SetProperty(ref _draftBadge, value);
    }
    ...
    {
        get => _branchInfo;
        set => SetProperty(ref _branchInfo, value);
    }
}
